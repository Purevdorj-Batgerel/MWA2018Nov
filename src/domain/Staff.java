...
public class Staff extends Person {
    ...
    public boolean addMovie(int id, String name, TypeMovie type, int time, String director, AgeRating rate, String description) {
        MovieScheduledFactory.createMovie(id, name, type, time, director, rate, description);
        return true;
    }
